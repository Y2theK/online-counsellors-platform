...
<head>
  ...
  <title>Online Counsellor Platform</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #1A202C">
      ...
      <a href="/" class="brand-link">
        ...
        <span class="brand-text font-weight-light">OCP </span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('admin.users.index') }}"
                    class="nav-link {{ request()->segment(2) == 'appointments' ? 'active' : '' }} ">
