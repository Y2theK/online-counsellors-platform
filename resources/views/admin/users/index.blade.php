      ...
      <div class="card text-light" style="background: #1A202C">
        ...
        <div class="card-body">
          ...
          <a href="{{ route('admin.users.create') }}" class="btn btn-primary float-left"><i
              class="fa fa-plus-circle m-1"></i>New Users</a>
          ...
          <table id="example1" class="table table-bordered table-striped  ">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ route('admin.users.show',$user->id) }}" class="btn text-success btn-sm"><i
                      class="fa fa-eye"></i></a>
                  <a href="{{ route('admin.users.edit',$user->id) }}" class="btn text-warning btn-sm"><i
